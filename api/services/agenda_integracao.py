...
# ⚠️ Re-exportado de propósito: os chamadores pedem
# `regra.agora_da_casa()`, e a suíte `smoke_agenda_fuso` cobra por esse nome.
from relogio import agora_da_casa  # noqa: F401
...
# 🔑 **O helper saiu daqui para `relogio.py`** (22/09/2026), quando o MESMO erro
# apareceu na tarja do site do cliente. Função que dois lugares distantes
# precisam não mora dentro de um deles — e a segunda ocorrência é a prova.
