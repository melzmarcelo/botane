...
Primeiro acesso **local**: o administrador nasce de `ADMIN_EMAIL`/`ADMIN_SENHA` — do seu
...
| API — credencial e autenticação do PDV Legal | `cd api && python tests/smoke_pdv_legal.py` |
