 ...
 *
 * 🔑 **Extraído da tela de Integrações em 09/09/2026** (pedido do dono: *"cria
 * uma aba e coloca as coisas do Omie, outra aba para o PDV Legal, outra para o
 * e-mail e demais"*). A tela tinha 751 linhas e dez cartões empilhados, sete
 * deles daqui — e o guia do projeto pede para dividir o que passa de ~300.
 *
 * ⚠️ **O estado é todo daqui.** `config`, `custos-iniciais` e `conferencia` são
 * do Omie e de mais ninguém: deixá-los na página faria a aba do e-mail carregar
 * a credencial do Omie para não usar.
 */
